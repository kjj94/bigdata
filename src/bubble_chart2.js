...
function bubbleChart() {
  ...
  var tipo_familia_Centers = {
    1: { x: width / 2, y: (height-margin.top*2)*1/8 +margin.top},
    2: { x: width / 2, y: (height-margin.top*2)*2/8 +margin.top},
    3: { x: width / 2, y: (height-margin.top*2)*3/8 +margin.top},
    5: { x: width / 2, y: (height-margin.top*2)*4/8 +margin.top},
    8: { x: width / 2, y: (height-margin.top*2)*5/8 +margin.top},
    9: { x: width / 2, y: (height-margin.top*2)*6/8 +margin.top},
    10: { x: width / 2, y: (height-margin.top*2)*7/8 +margin.top}
  };
